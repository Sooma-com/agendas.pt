...
pub async fn migrate(pool: &SqlitePool) -> Result<()> {
    ...
    let migrations: &[(&str, &str)] = &[
        ...
        (
            "059_event_type_en_translation",
            include_str!("../migrations/059_event_type_en_translation.sql"),
        ),
        (
            "060_user_active_languages",
            include_str!("../migrations/060_user_active_languages.sql"),
        ),
        (
            "061_event_type_translations",
            include_str!("../migrations/061_event_type_translations.sql"),
        ),
        (
            "062_user_translations",
            include_str!("../migrations/062_user_translations.sql"),
        ),
        (
            "063_team_translations",
            include_str!("../migrations/063_team_translations.sql"),
        ),
        (
            "064_team_translation_name",
            include_str!("../migrations/064_team_translation_name.sql"),
        ),
        (
            "065_resources",
            include_str!("../migrations/065_resources.sql"),
        ),
        (
            "066_resource_sync_error",
            include_str!("../migrations/066_resource_sync_error.sql"),
        ),
        (
            "067_resource_teams",
            include_str!("../migrations/067_resource_teams.sql"),
        ),
        (
            "068_booking_unique_per_member",
            include_str!("../migrations/068_booking_unique_per_member.sql"),
        ),
    ];
...
mod tests {
    ...
    async fn migrate_tracks_applied_migrations() {
        ...
        let count: (i64,) = sqlx::query_as("SELECT COUNT(*) FROM _migrations")
            ...
            .await
            .unwrap();
        assert_eq!(count.0, 68, "All 68 migrations should be tracked");
    }
    ...
    async fn migrate_is_idempotent() {
        ...
        let count: (i64,) = sqlx::query_as("SELECT COUNT(*) FROM _migrations")
            ...
            .await
            .unwrap();
        assert_eq!(count.0, 68, "Still 68 migrations after second run");
    }
